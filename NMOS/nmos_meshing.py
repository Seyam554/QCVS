...
devsim.node_model(name="Acceptors", device=device, region="bulk", equation="NetDoping * (NetDoping < 0) * -1")
devsim.node_model(name="Donors", device=device, region="bulk", equation="NetDoping * (NetDoping > 0)")
devsim.node_model(name="Acceptors", device=device, region="gate", equation="NetDoping * (NetDoping < 0) * -1")
devsim.node_model(name="Donors", device=device, region="gate", equation="NetDoping * (NetDoping > 0)")

# Fix Donors/Acceptors missing problem which causes floating point exceptions
devsim.node_model(name="Acceptors", device=device, region="bulk", equation="NetDoping * (NetDoping < 0) * -1 + 1.0")
devsim.node_model(name="Donors", device=device, region="bulk", equation="NetDoping * (NetDoping > 0) + 1.0")
devsim.node_model(name="Acceptors", device=device, region="gate", equation="NetDoping * (NetDoping < 0) * -1 + 1.0")
devsim.node_model(name="Donors", device=device, region="gate", equation="NetDoping * (NetDoping > 0) + 1.0")
